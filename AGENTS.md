...
- For package executables that pass flags through `npx`/`pnpm dlx`, use `rtk proxy npx ...`
  or `rtk proxy pnpm dlx ...` so arguments are not interpreted as project scripts.
<!-- /headroom:rtk-instructions -->
