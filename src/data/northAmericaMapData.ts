export type NaturalEarthCoordinate = readonly [number, number];
...
export const northAmericaMapFeatures = [
  {
    id: "natural-earth-can",
    name: "Canada",
    kind: "land",
  ...
  {
    id: "natural-earth-lake-superior",
    name: "Lake Superior",
    kind: "water",
    source: "natural-earth-vector",
    geometry: {
  ...
  {
    id: "natural-earth-lake-michigan",
    name: "Lake Michigan",
    kind: "water",
    source: "natural-earth-vector",
    geometry: {
...
] as const satisfies readonly NaturalEarthMapFeature[];
